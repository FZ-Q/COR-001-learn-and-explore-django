...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        test_was_published_recently() return False for question whose pub_date
        is older than 1 day.
        """
...
def create_question(question_text, days):
    """
    Create a question with the given `question_text` and publised the
    given number of `days` offset to now (navigate for question published
    in the past, positive for quvstion that have yet to be published).
    """
